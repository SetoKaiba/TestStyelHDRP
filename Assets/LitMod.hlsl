...
DirectLighting ShadeSurface_Directional_Mod(LightLoopContext lightLoopContext,
                                        ...
                                        BSDFData bsdfData, float3 V)
{
    ...
    if ((light.lightDimmer > 0) && IsNonZeroBSDF(V, L, preLightData, bsdfData))
    {
        ...
        lightColor.rgb *= float3(1,0.5,0.5);
...
{
    return ShadeSurface_Directional_Mod(lightLoopContext, posInput, builtinData, preLightData, lightData, bsdfData, V);
}
